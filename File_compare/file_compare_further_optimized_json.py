import json,time, cProfile, pstats
...
list1 = inputToList("files_for_test_exec_time/file1_500000.txt") #1L 2000 sec.
list2 = inputToList('files_for_test_exec_time/file2_500000.txt')
...
cProfile.run("mainFunc(sorted_list1, list2)",filename='output.dat')
